...
(()=>{
   ...
   if(fs.existsSync(filePath)){
      ...
      function reloadEvents(){
         if (depurador == true){
         console.log(`Update Bot MODS: Обновление ${Files.data.events.length} событий...`)}
      ...
      function reloadCommands(){
         if (depurador == true){
         console.log(`Update Bot MODS: Обновление ${data.length} команд...`)}
...
Bot.$other = {}
      ...
      if(atualizar === "0"){
         ...
         try {
            ...
            console.error(error)
            if (depurador == true){console.log(`Update Bot MODS: Не удалось обновить все`)}
            falhou = "true"
            return           
         }
         if (depurador == true){console.log(`Update Bot MODS: Все данные бота обновлены!`)}
         return 
      } 
      ...
      if(atualizar == "2"){
         try {
            ...
            console.error(error)
            if (depurador == true){console.log(`Update Bot MODS: Не удалось обновить все события.`)}
            falhou = "true"
            return
         }

         if (depurador == true){console.log(`Update Bot MODS: Все ${Files.data.events.length} события обновлены!`)}
         return 
      }
      if(atualizar == "1"){
         ...
         try {
            ...
            console.error(error)
            if (depurador == true){console.log(`Update Bot MODS: Не удалось обновить все команды!`)}
            falhou = "true"
            return
         }

         if (depurador == true){console.log(`Update Bot MODS: Все ${data.length} команды обновлены!`)}
         return 
      }
      ...
      if(found.length > 1) return gatilhosxin = "2", captados = found.map(c=>c.name)
         ...
         if(com) {
            ...
            if (depurador == true){console.log(`Команда '${com.name}' была обновлена!`)}
         }
