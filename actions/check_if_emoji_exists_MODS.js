module.exports = {
  ...
  name: "Check if Emoji Exists MOD",
  ...
  fields: ["info", "find", "mode", "branch", "server", "varName"],
  ...
  html(isEvent, data) {
    ...
    <dbm-checkbox id="mode" label="Просмотреть все серверы" onchange="glob.change(this)"></dbm-checkbox>
    ...
    <div>
      <div style="float: left; width: 40%;">
        ...
        <select id="info" class="round">
          <option value="0" selected>По id</option>
          <option value="1">Название</option>
        </select>
      </div>
      <div style="float: right; width: 55%;">
        <span class="dbminputlabel">Ишем?</span><br>
